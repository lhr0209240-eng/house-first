...
export function About() {
  ...
  const defaultInfo = {
    title: "소개",
    subtitle: "전공·자격·경험을 통해 쌓아온 저의 성장 과정과 목표를 정리한 소개 섹션입니다.",
    background: {"image":"","video":"","color":"","opacity":0.1},
    experienceCards: [{"icon":"graduation","title":"단국대학교 부동산학 주전공","period":"2021.03-2027.02(예정)","description":"도시 구조와 부동산 가치 형성 원리를 체계적으로 학습하며, 효율적인 공간 계획과 균형 있는 도시 발전을 위한 전문 지식을 다짐"},{"icon":"graduation","title":"단국대학교 도시계획학 부전공","period":"2021.03-2027.02(예정)","description":"도시의 성장 원리와 공간 구조를 체계적으로 연구하며, 도시 계획 과정에서 요구되는 분석 능력과 정책적 판단 역량을 기름"},{"icon":"award","title":"투자자산운용사","period":"2025","description":"금융 시장의 구조와 자산 운용 전략을 이해하고, 투자 분석·포트폴리오 구성·리스크 관리 업무를 수행할 수 있는 전문 자산운용 역량을 보유"},{"icon":"award","title":"JLPT N3","period":"2025","description":"일상적인 주제에 관한 일본어 문장과 정보를 이해하고 활용할 수 있으며, 기본적인 비즈니스 상황에서도 원활한 의사소통이 가능한 수준의 일본어 능력 보유"},{"icon":"award","title":"바리스타 2급","period":"2021","description":"서비스 경험을 통해 고객 응대 능력과 현장 커뮤니케이션 역량을 강화하였으며, 매장 운영 과정에서 책임감과 협업 능력을 실무적으로 발전시킨 경험 보유"},{"icon":"target","title":"37회 공인중개사(목표)","period":"2026","description":"부동산 법률·권리관계 이해도를 높이기 위해 자격 취득을 준비 중이며, 실무 기반의 중개 역량과 법적 판단 능력 강화를 목표"},{"icon":"target","title":"도시계획기사(목표)","period":"2026 or 2027","description":"도시 구조 분석과 계획 수립 능력을 전문적으로 확장하기 위해 도시계획기사 자격 취득을 목표로 하며, 실무 중심의 도시 분석·계획 역량 강화"},{"icon":"target","title":"JLPT N2(목표)","period":"2026","description":"일본어 실무 활용 능력을 확대하기 위해 N2 자격 취득을 목표로 학습 중"},{"icon":"target","title":"일본 워킹홀리데이(예정)","period":"2026 or 2027","description":"현지 생활과 업무 환경을 직접 경험하고자 일본 워킹홀리데이를 계획 중임. 실무 일본어 능력과 문화 이해도를 높여 향후 일본 취업 및 글로벌 역량 확장을 지향"},{"icon":"briefcase","title":"창원시 마산합포구청(사무보조)","period":"2023.07~08","description":"주차 정책과 도시 교통 운영에 관한 행정 실무를 경험하며, 도시계획·부동산 분야에서 중요한 도시관리·공간운영 관점을 실무적으로 이해하는 역량 강화"},{"icon":"briefcase","title":"신세계백화점 컨시어지","period":"2025.01~02, 2025.07~08","description":"고객 경험 개선, 서비스 동선 관리, 매장 운영 지원 등을 수행하며 상업시설의 운영 프로세스를 실무적으로 익힘. 이는 부동산 자산관리·도시 상권계획에서 요구되는 공간 운영 이해도 향상으로 역량 강화"}],
    skills: [{"icon":"pieChart","title":"도시재생 및 공간 분석","description":"R 기반의 도시 주택시장 관련 데이터 해석·시각화"},{"icon":"barChart","title":"사업성 및 타당성 분석 기획","description":"부동산 투자지표(NPV·IRR 등)를 활용하여 프로젝트의 가치와 리스크 검토"},{"icon":"target","title":"도시재생 전략 기획","description":"도시 구조·인프라 변화를 분석해 개선 방향을 제시하고 전략을 기획"}],
    storyTitle: "나의 이야기",
    story: ["도시는 하나의 유기체처럼 끊임없이 변화합니다. 인구, 교통, 상권, 정책, 그리고 사람들의 선택이 서로 얽히며 새로운 패턴을 만들어 냅니다.\n저는 이 복잡한 흐름을 데이터와 현장 분석이라는 두 가지 렌즈로 바라보며 도시의 ‘변화의 이유’를 파악하는 데 큰 흥미를 느껴왔습니다.","저는 단순히 공간을 바라보는 것을 넘어, 도시 문제의 구조적 원인을 찾는 힘을 키웠습니다.\n춘천역세권 개발 기본구상안을 작성하며 도시 성장 모델을 직접 설계했고, 신도시 교통 인프라 부족 문제와 시민안전 확보를 위한 지역계획 연구를 수행하며 교통·환경·정책이 도시의 삶에 미치는 영향을 통합적으로 분석했습니다. 또한 용인시 환경문제 분석, 자원순환센터 건립 타당성 연구 등 다양한 프로젝트를 수행하며, 데이터 기반 의사결정의 중요성을 체감했습니다. 수치 분석만으로는 보이지 않는 한계는 현장을 통해 보완했고, 현장에서 들리지 않는 목소리는 다시 데이터로 검증하며 균형점을 찾는 과정을 반복했습니다.","저의 경험은 단순한 보고서 작성을 넘어섭니다.\n프로젝트에서는 팀원들과 함께 도시 문제의 원인을 토론하고, 조사 방향을 합의하며, 서로의 관점을 확장시키는 과정 속에서 협업과 조율 능력을 자연스럽게 키웠습니다.\n군대와 다양한 사회 경험을 통해 얻게 된 책임감·성실함·끈기는 이러한 분석 과정의 기초가 되었습니다.\n\n도시계획, 재생, 주택시장 분석은 복잡한 분야입니다. 그렇기에 더 깊이 이해하고 싶고, 더 나은 답을 찾고 싶습니다.\n앞으로도 다양한 프로젝트와 실무 경험을 통해 전문성을 확장하며,\n데이터와 도시를 연결해 실제 변화를 설계할 수 있는 전문가로 성장하고자 합니다."],
    storyImage: "/uploads/about-image-1765046297513.jpeg",
    hobbies: ["✈️ 여행","🎮 게임","🎯 야구","🎯 스포츠 시청"]
  }
