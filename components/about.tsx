...
export function About() {
  ...
  const defaultInfo = {
    title: "소개",
    subtitle: "도시를 이해하려는 저의 시간을 소개합니다",
    background: {"image":"","video":"","color":"","opacity":0.1},
    experienceCards: [{"icon":"graduation","title":"단국대학교 도시계획부동산학부","period":"2021.03-2027.02(예정)","description":"전공 및 학위"},{"icon":"award","title":"투자자산운용사 취득","period":"2025","description":"자격증"},{"icon":"award","title":"JLPT N3","period":"2025","description":"자격증"},{"icon":"award","title":"바리스타 2급","period":"2021","description":"자격증"},{"icon":"award","title":"공인중개사(예정)","period":"2026","description":"자격증"},{"icon":"award","title":"JLPT N2(예정)","period":"2026","description":"자격증"},{"icon":"award","title":"도시계획기사(예정)","period":"2026 or 2027","description":"자격증"},{"icon":"target","title":"일본 워킹홀리데이","period":"2026 or 2027","description":"워킹홀리데이"}],
